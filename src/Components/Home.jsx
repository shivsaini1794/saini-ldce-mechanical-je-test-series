...
<p>Prepare Smart. Score High. Achieve Your Railway LDCE Mechanical JE Goal.</p>
      ...
      <button>
        💎 Buy Premium Test Series
      </button>

      <div className="features">

        <div className="card" onClick={premiumClick} style={{ cursor: "pointer" }}>
          <h3>
